...
class RestaurantsScreenContent extends StatefulWidget {
  ...
  const RestaurantsScreenContent({Key key, this.restaurants}) : super(key: key);
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemCount: widget.restaurants.restaurants.length,
            itemBuilder: (context, index) {
              return RestaurantListItemWidget(restaurant: widget.restaurants.restaurants[index],);
            },
          ),
        ),
      ]),
