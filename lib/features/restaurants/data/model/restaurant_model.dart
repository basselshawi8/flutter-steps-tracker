...
class RestaurantListModel extends BaseModel<RestaurantListEntity> {
  ...
  factory RestaurantListModel.fromJson(String str) => RestaurantListModel.fromMap(json.decode(str));

  factory RestaurantListModel.fromMap(List<dynamic> json) => RestaurantListModel(
...
class RestaurantModel extends BaseModel<RestaurantEntity>{
  ...
  factory RestaurantModel.fromMap(Map<String, dynamic> json) => RestaurantModel(
    ...
    status: json["status"],
    prices: json["prices"],
    topComments: List<TopCommentModel>.from(json["top_comments"].map((x) => TopCommentModel.fromMap(x))),
  ...
  Map<String, dynamic> toMap() => {
    ...
    "status": status,
    "prices": prices,
    "top_comments": List<dynamic>.from(topComments.map((x) => x.toMap())),
...
class TopCommentModel extends BaseModel<TopCommentEntity> {
  ...
  factory TopCommentModel.fromJson(String str) => TopCommentModel.fromMap(json.decode(str));
