          ...
          builder: (context, state, _) {
            if (state.currentIncident != null) {
              ...
              incidentType = state.currentIncident.classification == "F"
                  ...
                  : "Behavioral Analysis";
              carID =
                  state?.currentIncident?.vehicle?.vehicleVehicleId?.toUpperCase() ?? "M2";
              suspectLevel =
                        ...
                        child: Column(
                            ...
                            children: [
                              ...
                              Consumer<IncidentsChangeNotifier>(
                                builder: (context, state, _) {
                                  var pinned = Provider.of<
                                              IncidentsChangeNotifier>(context,
                                          listen: false)
                                      .incidents
                                      .firstWhere(
                                          (element) =>
                                  ...
                                  return InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                          color:
                                              Color(0xF272727).withOpacity(0.7),
                                          borderRadius:
                                        ...
                                        if (state
                                          ...
                                          WidgetsBinding.instance
                                            ...
                                            Provider.of<IncidentsChangeNotifier>(
                                                        context,
                                                        listen: false)
                                                    .updateHomeIncidentClassifications =
                                                true;
                                          });
                                        } else if (state
                                            is GetIncidentFailureState) {
                                          setState(() {
                                            _isAsync = false;
                                          });
                                        }
